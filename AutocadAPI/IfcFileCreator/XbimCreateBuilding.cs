   ...
   public class XbimCreateBuilding
    {
        ...
        IfcSlab slab = null;
        public XbimCreateBuilding(Building cadBuilding)
        {
            using (var model = CreateandInitModel("Demo1"))
            {
                ...
                if (model != null)
                {
                    ...
                    try
                    {
                        ...
                        //write the Ifc File
                        model.SaveAs(@"F:\Work\Demo1.ifc", IfcStorageType.Ifc);
        ...
        static private IfcSlab CreateSlab(IfcStore model, Slab cadSlab)
        {
            cadSlab.Length *= 1000;
            cadSlab.Width *= 1000;
