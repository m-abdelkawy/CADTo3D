...
namespace AutocadAPI
{
    public static class IFCHelper
    {
        ...
        internal static void ProfileInsertionPointSet(this IfcRectangleProfileDef rectProf, IfcStore model, double x, double y, double z = 0)
        {
            IfcCartesianPoint insertionPoint = model.Instances.New<IfcCartesianPoint>();
            insertionPoint.SetXYZ(x, y, z);
